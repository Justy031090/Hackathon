...
const TEXTS = [
  `Welcome to the ShirZam, the site was built in order to solve the
...
own language`,
  ...
  `
  Добро пожаловать в ShirZam, сайт был создан для того что бы преодолеть языковой барьер,
  ...
  `ברוכים הבאים לשירזם , האתר נבנה לטובת 
  ...
  return (
    <div className="home-container">
      <h1 className="home-title">
        <span className="home-title2">Shir</span>Zam
      </h1>
